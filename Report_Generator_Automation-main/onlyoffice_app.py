#!/usr/bin/env python3
"""
OnlyOffice Document Editor - Main Application
PyQt6 desktop application with OnlyOffice Document Server integration
"""
...
from onlyoffice_document_editor import OnlyOfficeServerManager, DocumentConverter
...
def main():
    ...
    app.setApplicationName("OnlyOffice Document Editor")
    app.setApplicationVersion("1.0.0")
    
    # Create and show main window
    window = DocumentEditorApp()
    window.show()
